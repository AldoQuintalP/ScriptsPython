...
def create(exportar,report,brach,cnn):
    ...
    try:
            ...
            cnn.commit()
            print("Tabla " +report+ "" +brach+ " creada correctamente en MySQL.")
...
def export(report,branch,cnn,client):
    ...
    print(f'Export sentencia 0 ....... {export_path}')
...
def change(report,branch,cnn,exportar):
 ...
 # Columnas a modificar
    columnas_a_cambiar = ["CostoActual","CostoUnit"]  # Agrega las columnas que deseas modificar
